...
public:
    ...
    //node_num_max:最大节点数,如果超出则增加50%内存并重新分配
    //edge_num_max:最大边数,如果超出同上
    //err_function:出错时调用的函数
    ...
    //添加从SOURCE到i的边,权重为cap_source,添加从i到SINK的边,权重为cap_sink
